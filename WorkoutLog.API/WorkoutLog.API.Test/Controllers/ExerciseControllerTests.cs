...
namespace WorkoutLog.API.Tests.Controllers
{
    public class ExerciseControllerTests : IClassFixture<ExerciseControllerFixture>, IDisposable
    {
        ...
        {
            _fixture.mockExerciseRepo.Setup(x => x.GetById(It.IsAny<int>())).ReturnsAsync(() => null!);
        ...
        public async Task Create_BadRequestResponse_ExceptionThrown()
        {
            ...
            _fixture.mockExerciseRepo.Setup(x => x.Insert(exercise)).ThrowsAsync(new Exception());
